        ...
        <SafeAreaView className='flex-1 bg-gray-200'>
            <View className='flex-1 bg-gray-100'>
                ...
                <View className='flex-1 flex-col items-center justify-center -mt-32 bg-white relative'>
                    <TouchableOpacity onPress={() => navigation.navigate('Login')} className='absolute top-[14%] left-5 bg-[#00CCBB] rounded-full' style={styles.buttonBox}>
                    ...
                    <PhoneInput
                        defaultCode="IN" disabled={true}
                        containerStyle={{ height: 52, }} placeholder={phone}
                        withDarkTheme
                        withShadow
                        autoFocus
                    />
