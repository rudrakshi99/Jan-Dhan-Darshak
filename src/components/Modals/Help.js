...
const Help = () => {
    ...
    const handleSubmit = async () => {
        try {
            ...
            const data = await createFeedback({ phone_number, name, email, topic, message, rating });
        ...
        <View style={styles.container}>
                <View>
                    ...
                    <Text style={styles.errorMsg}>{error}</Text>
                        ...
                        ></InputField>
                        <InputField
                            inputname="Name" help={true} keyboardType="default"
                            name={name}
                            onChangeText={(e) => {
                                setName(e);
                            }}
                        ...
                        ></InputField>
                        <InputField
                            inputname="Email" help={true} keyboardType="email-address"
                            name={email}
                            onChangeText={(e) => {
                                setEmail(e);
                            }}
                        ...
                        <View style={styles.borderGet}>
                            <RNPickerSelect
                                ...
                                items={[
                                    ...
                                    { label: 'Design Issue', value: 'design_issue' },
                        ...
                        <AirbnbRating onFinishRating={(rating) => ratingCompleted(rating)}
                            reviews={["Poor", "Fine", "Good", "Very good", "Excellent"]}
                            defaultRating={5} showRating={false}
                            size={36}
                        />
